...
with corrente as (
    ...
    where tag_name = 'Corrente - Sabroe 01'
    group by data_hora
),
...
pressao_descarga as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Pressão de Descarga - Sabroe 01'
    group by data_hora
),
...
temp_descarga as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Temperatura de Descarga - Sabroe 01'
    group by data_hora
),
...
pressao_oleo as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Pressão de Óleo - Sabroe 01'
    group by data_hora
),
...
temp_oleo as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Temperatura do Óleo - Sabroe 01'
    group by data_hora
),
...
superaquecimento_aspiracao as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Superaquecimento de Aspiração - Sabroe 01'
    group by data_hora
),
...
pressao_aspiracao as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Pressão de Aspiração - Sabroe 01'
    group by data_hora
),
...
temp_processo as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Temperatura de Processo - Sabroe 01'
    group by data_hora
),
...
temp_aspiracao as (
    ...
    from {{ ref('stg_compressao_liquefacao_data') }}
    where tag_name = 'Temperatura de Aspiração - Sabroe 01'
    group by data_hora
),
