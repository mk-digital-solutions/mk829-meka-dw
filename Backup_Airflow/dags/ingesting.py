...
with DAG(
    dag_id="ingestaDados",  # Mudei a versão
    ...
    ingest_metadata = BashOperator(
        ...
        # Instalação limpa apenas do conector
        pip install -q cachetools "openmetadata-ingestion[dbt]"
    ...
    # Ordem de execução:
    # 1. Cria tabelas -> 2. Gera Documentação (JSONs) -> 3. Envia para o OM
